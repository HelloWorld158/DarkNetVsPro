...
void forward_convolutional_layer_gpu_predict_Float16(convolutional_layer l, network net)
{
    ...
    /*if (GetDataType() == CUDNN_DATA_FLOAT)
    {
        ...
        cuda_convert_f16_to_f32((half*)publicMemory[1], l.outputs, l.output_gpu);
        add_bias_gpu(l.output_gpu, l.biases_gpu, l.batch, l.n, l.out_w * l.out_h);
        activate_array_ongpu(l.output_gpu, l.outputs * l.batch, l.activation);
        cuda_convert_f32_to_f16(l.output_gpu, l.outputs, publicMemory[1]);
        if (output == l.output_gpu)
        {
            cudaMemcpy(l.output_gpu, publicMemory[1], l.outputs * sizeof(half));
        }
